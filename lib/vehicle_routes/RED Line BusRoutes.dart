...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> findBusRoutes() async {
    ...
    await rootBundle.loadString('jsondata/Red_line_routes.json');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Red Line Bus Routes'),
        centerTitle: true,
      ),
      body: Padding(
...
// class move_to_map extends StatelessWidget {
//   const move_to_map({super.key});
//
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
