...
class Mini_busRoutes extends StatefulWidget {
  const Mini_busRoutes({super.key});

  @override
  State<Mini_busRoutes> createState() => _Mini_busRoutesState();
}

class _Mini_busRoutesState extends State<Mini_busRoutes> {
  ...
  Future<void> findBusRoutes() async {
    ...
    await rootBundle.loadString('jsondata/Mini_Bus_Route.json');
