...
class Greenline_route extends StatefulWidget {
  const Greenline_route({super.key});

  @override
  State<Greenline_route> createState() => _Greenline_routeState();
}

class _Greenline_routeState extends State<Greenline_route> {
  ...
  Future<void> findBusRoutes() async {
    ...
    await rootBundle.loadString('jsondata/Green_Line_Service_Routes.json');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Green Line Bus Routes'),
        centerTitle: true,
      ),
      body: Padding(
